...
$gender_error = $this->set_dog_gender($value1) == TRUE ? 'TRUE,' : 'FALSE,';
$name_error = $this->set_dog_name($value2) == TRUE ? 'TRUE,' : 'FALSE,';
$breed_error = $this->set_dog_breed($value3) == TRUE ? 'TRUE,' : 'FALSE,';
$color_error = $this->set_dog_color($value4) == TRUE ? 'TRUE,' : 'FALSE,';
$weight_error= $this->set_dog_weight($value5) == TRUE ? 'TRUE' : 'FALSE';

$this->error_message = $gender_error . $name_error . $breed_error . $color_error . $weight_error;
...
$error_message = TRUE; (($value) == 'Male' || ($value) == 'Female') ? $this->dog_gender = $value : $error_message = FALSE;
...
{
return "$this->dog_gender,$this->dog_weight,$this->dog_breed,$this->dog_color.";
}
