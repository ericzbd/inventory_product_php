...
$lab = new Dog('Male','Fred','Lab','Yellow','100');

list($gender_error, $name_error, $breed_error, $color_error, $weight_error) = explode(',', $lab);
...
list($dog_gender, $dog_weight, $dog_breed, $dog_color) = explode(',', $dog_properties);
print "Dog gender is $dog_gender. Dog weight is $dog_weight. Dog breed is $dog_breed. Dog color is $dog_color.";
?>
